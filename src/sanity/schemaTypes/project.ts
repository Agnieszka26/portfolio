...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'text',
      fieldset: 'caseStudy',
      description: 'Long-form introduction for the case study page. Supports Markdown.',
    }),
    defineField({
      name: 'technologies',
      title: 'Technologies',
      type: 'text',
      fieldset: 'caseStudy',
      description: 'Tech stack and tools used in the project.',
    }),
    defineField({
      name: 'backend',
      title: 'Backend',
      type: 'text',
      fieldset: 'caseStudy',
      description: 'Backend architecture, APIs, and data layer details.',
    }),
    defineField({
      name: 'keyFeatures',
      title: 'Key Features',
      type: 'text',
      fieldset: 'caseStudy',
      description: 'Notable features and implementation highlights.',
    }),
    defineField({
      name: 'challenges',
      title: 'Challenges',
      type: 'text',
      fieldset: 'caseStudy',
      description: 'Optional section describing problems solved during development.',
    }),
    defineField({
      name: 'slides',
      title: 'Slides',
